...
const Block4Component = () => {
  return (
    <div className='h-[900px] w-full bg-[#F9F9FD] z-40 relative items-center justify-center flex flex-col'>
        <div className='flex gap-20'>
            <div className='flex gap-10 items-center justify-center'>
                <div className='flex flex-col gap-10 mt-14'>
                    <div className='w-[270px] h-[300px] rounded-[20px] bg-white items-center justify-center flex flex-col text-center gap-5'>
            ...
            <div className='flex flex-col gap-[35px]'>
                <p className='font-semibold text-[56px] whitespace-pre-line leading-15'>{`Customer\n satisfaction is\n our first priority`}</p>
